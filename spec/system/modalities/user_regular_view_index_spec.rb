...
describe 'Usuário visita página de modalidades' do
    it 'e vê o Modalidades de Frete Cadastrados, mas não pode adicionar nem editar modalidades' do
        #Arrange
    ...
    it 'não existem modalidades cadastradas e não pode adicionar modalidades' do
        #Arrange
        user = UserRegular.create!(name: 'Manu', email: 'manu@sistemadefrete.com.br', password: 'password')
        #Act
        visit root_path 
